...
mkdir -p /home/ec2-user/eks-client-install  # -p option is particularly useful when you want to ensure the existence of a directory structure and create it if it doesn't exist yet.
